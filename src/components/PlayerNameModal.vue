    ...
    <div v-if="isVisible" class="modal-overlay" @click.self="handleOverlayClick">
        <div class="modal-container">
            ...
            <div class="modal-body">
                ...
                <input ref="nameInput" v-model="playerName" type="text" placeholder="Your name" maxlength="20" class="name-input" @keyup.enter="handleSubmit" />
                <p v-if="errorMessage" class="error-message">{{ errorMessage }}</p>
            </div>
            <div class="modal-footer">
                <button class="btn-primary" :disabled="!playerName.trim()" @click="handleSubmit">Join Game</button>
            </div>
        </div>
    </div>
</template>
